...
|---|---|---|---|
| Sebastien Tanapon Chapelin (Programmer) | เขียนโค้ดเดินซ้าย-ขวาเสร็จ และทดสอบ Import Sprite เข้า
...
|
| Pichaicharn Promma (Programmer) | วางโครงสร้าง ScreenManager และหน้า Title Screen |
...
- [ ] [ช่วย Sebastien Tanapon Chapelin แก้สมการ Gravity และ Jump Physics] [status:: doing]
